...
GNewForm.prototype.getCreateOrderButton = function () {
...
GNewForm.prototype.getConfirmPhoneButton = function () {
    return $('#go_to_step3');
};

GNewForm.prototype.getSmsCodeField = function () {
    return $('#smsCode');
};

GNewForm.prototype.getSendSmsAgainButton = function () {
    return '.send_again';
};